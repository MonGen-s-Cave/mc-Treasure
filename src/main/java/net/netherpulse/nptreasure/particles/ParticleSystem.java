package net.netherpulse.nptreasure.particles;
...
import net.netherpulse.nptreasure.interfaces.ParticleEffect;
import net.netherpulse.nptreasure.particles.models.Heart;
import net.netherpulse.nptreasure.particles.models.Helix;
import net.netherpulse.nptreasure.particles.models.Pulsar;
import net.netherpulse.nptreasure.particles.models.Sphere;
import net.netherpulse.nptreasure.particles.models.Tornado;
import net.netherpulse.nptreasure.utils.LoggerUtils;
...
public class ParticleSystem {
    ...
    private final NpTreasure plugin = NpTreasure.getInstance();

    @Getter
    private final ConcurrentHashMap<ParticleTypes, ParticleEffect> registeredEffects;
