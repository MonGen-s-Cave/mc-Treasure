package net.netherpulse.nptreasure.identifiers;
...
public enum ParticleTypes {
    ...
    public String getDropdownDisplay() {
        ParticleTypes prev = this.previous();
        ParticleTypes next = this.next();

        return prev.getDisplayName() + " &a▶ &6" + this.getDisplayName() + " " + next.getDisplayName();
    }
}
